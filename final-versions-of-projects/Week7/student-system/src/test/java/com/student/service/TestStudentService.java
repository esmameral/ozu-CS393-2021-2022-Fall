...
class TestStudentService {
	...
	void testSaveInstructorAndAssignCourse() {
		...
		course.setCode("CS390");
		course.setName("Test");
		courseService.save(course);
		instructorService.assignCourse(instructor, course.getCode());
		assertTrue(instructor.getId() > 0);
	}
	...
	void testEnrollStudentToCourse() {
		...
		List<Student> list = studentService.findByCourseCode("CS393");
	...
	public void testGradeCalculation() {
		studentService.calculateGrade(1, "CS391");
	}
